...
ax.set_title(f"Curvas ROC One-vs-Rest — v4 (val)\nAUC macro = {macro_roc:.3f}",
             fontweight="bold", color="#1F3864")
ax.legend(loc="lower right", fontsize=9); ax.grid(alpha=0.3)
plt.tight_layout()
plt.savefig(Path(__file__).resolve().parent / "Figure_roc_v4.png", dpi=150, bbox_inches="tight")
print("\nGuardado Figure_1.png, Figure_2_matriz.png y Figure_roc_v4.png")
