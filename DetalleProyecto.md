...
├── TensorFlow/  v1..v5/         entrenamiento espejo + requirements.txt
│   └── export_tfjs/             exportar_tfjs.py + requirements_tfjs.txt (venv aparte)
├── PyTorch/     v1..v5/         entrenamiento espejo + requirements.txt
├── modelos/
...
- **T8 — Opcionales con señal del profe** (solo si sobra tiempo): v6 fine-tuning en dos
  fases; v7 Optuna sobre la cabeza; curvas ROC one-vs-rest.
